...
.method constructor <init>(Lb/b/c/a/b$a;)V
    ...
    iget-object p1, p1, Lb/b/c/a/b$a;->b:[F

    array-length v0, p1

    const/4 v1, 0x0

    invoke-static {p1, v1, v0}, Lb/b/c/a/b;->a([FII)[F

    move-result-object p1

    iput-object p1, p0, Lb/b/c/a/b$a;->b:[F
...
.method private static a(Landroid/graphics/Path;FFFFFFFZZ)V
    ...
    invoke-static/range {v0 .. v9}, Lb/b/c/a/b$a;->a(Landroid/graphics/Path;FFFFFFFZZ)V
...
.method public static a([Lb/b/c/a/b$a;Landroid/graphics/Path;)V
    ...
    if-ge v10, v2, :cond_3cc

    aget-object v2, v0, v10

    iget-char v9, v2, Lb/b/c/a/b$a;->a:C

    aget-object v2, v0, v10

    iget-object v8, v2, Lb/b/c/a/b$a;->b:[F
    ...
    sparse-switch v9, :sswitch_data_3ce
    ...
    if-ge v7, v3, :cond_3ad

    const/16 v3, 0x41

    if-eq v9, v3, :cond_358

    const/16 v3, 0x43

    if-eq v9, v3, :cond_329

    const/16 v15, 0x48

    if-eq v9, v15, :cond_315

    const/16 v15, 0x51

    if-eq v9, v15, :cond_2ee

    const/16 v12, 0x56

    if-eq v9, v12, :cond_2da
    ...
    if-eq v9, v12, :cond_24b

    const/16 v3, 0x68

    if-eq v9, v3, :cond_23a

    const/16 v3, 0x71

    if-eq v9, v3, :cond_216

    const/16 v12, 0x76

    if-eq v9, v12, :cond_203
    ...
    if-eq v9, v12, :cond_189

    const/16 v12, 0x54

    const/16 v3, 0x74

    if-eq v9, v12, :cond_156

    const/16 v12, 0x6c

    if-eq v9, v12, :cond_13e

    if-eq v9, v14, :cond_116

    if-eq v9, v15, :cond_d2
    ...
    invoke-static/range {v1 .. v10}, Lb/b/c/a/b$a;->a(Landroid/graphics/Path;FFFFFFFZZ)V
    ...
    iget-char v1, v0, Lb/b/c/a/b$a;->a:C
...
.method public a(Lb/b/c/a/b$a;Lb/b/c/a/b$a;F)V
    ...
    iget-object v1, p2, Lb/b/c/a/b$a;->b:[F
