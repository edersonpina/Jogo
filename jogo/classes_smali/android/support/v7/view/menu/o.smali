...
.method private a(IIZZ)V
    ...
    iget p3, p0, Landroid/support/v7/view/menu/o;->g:I

    iget-object p4, p0, Landroid/support/v7/view/menu/o;->f:Landroid/view/View;

    invoke-static {p4}, Landroid/support/v4/view/n;->d(Landroid/view/View;)I

    move-result p4

    invoke-static {p3, p4}, La/a/g;->a(II)I
    ...
    iget-object p3, p0, Landroid/support/v7/view/menu/o;->f:Landroid/view/View;
    ...
    iget-object p3, p0, Landroid/support/v7/view/menu/o;->a:Landroid/content/Context;
    ...
    invoke-virtual {v0, p4}, Landroid/support/v7/view/menu/n;->a(Landroid/graphics/Rect;)V
...
.method public a(II)Z
    ...
    :cond_8
    iget-object v0, p0, Landroid/support/v7/view/menu/o;->f:Landroid/view/View;
    ...
    :cond_e
    invoke-direct {p0, p1, p2, v1, v1}, Landroid/support/v7/view/menu/o;->a(IIZZ)V
...
.method public b()Landroid/support/v7/view/menu/n;
    ...
    iget-object v8, p0, Landroid/support/v7/view/menu/o;->a:Landroid/content/Context;

    iget-object v9, p0, Landroid/support/v7/view/menu/o;->b:Landroid/support/v7/view/menu/h;

    iget-object v10, p0, Landroid/support/v7/view/menu/o;->f:Landroid/view/View;

    iget v11, p0, Landroid/support/v7/view/menu/o;->d:I

    iget v12, p0, Landroid/support/v7/view/menu/o;->e:I

    iget-boolean v13, p0, Landroid/support/v7/view/menu/o;->c:Z

    move-object v7, v0

    invoke-direct/range {v7 .. v13}, Landroid/support/v7/view/menu/u;-><init>(Landroid/content/Context;Landroid/support/v7/view/menu/h;Landroid/view/View;IIZ)V
...
.method public e()Z
    ...
    :cond_e
    invoke-direct {p0, v2, v2, v2, v2}, Landroid/support/v7/view/menu/o;->a(IIZZ)V
