...
.field H:Landroid/support/v7/widget/Toolbar$f;

.field private final I:Landroid/support/v7/widget/ActionMenuView$e;

.field private J:Landroid/support/v7/widget/a1;

.field private K:Landroid/support/v7/widget/ActionMenuPresenter;

.field private L:Landroid/support/v7/widget/Toolbar$d;
...
.field private u:Landroid/support/v7/widget/q0;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, Lb/b/d/a/a;->toolbarStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v0, Lb/b/d/a/j;->Toolbar:[I
    ...
    sget p2, Lb/b/d/a/j;->Toolbar_titleTextAppearance:I
    ...
    sget p2, Lb/b/d/a/j;->Toolbar_subtitleTextAppearance:I
    ...
    sget p2, Lb/b/d/a/j;->Toolbar_android_gravity:I

    iget p3, p0, Landroid/support/v7/widget/Toolbar;->x:I

    invoke-virtual {p1, p2, p3}, Landroid/support/v7/widget/y0;->e(II)I

    move-result p2

    iput p2, p0, Landroid/support/v7/widget/Toolbar;->x:I

    sget p2, Lb/b/d/a/j;->Toolbar_buttonGravity:I
    ...
    sget p2, Lb/b/d/a/j;->Toolbar_titleMargin:I

    invoke-virtual {p1, p2, v1}, Landroid/support/v7/widget/y0;->b(II)I

    move-result p2

    sget p3, Lb/b/d/a/j;->Toolbar_titleMargins:I

    invoke-virtual {p1, p3}, Landroid/support/v7/widget/y0;->g(I)Z
    ...
    invoke-virtual {p1, p3, p2}, Landroid/support/v7/widget/y0;->b(II)I
    ...
    sget p2, Lb/b/d/a/j;->Toolbar_titleMarginStart:I

    const/4 p3, -0x1

    invoke-virtual {p1, p2, p3}, Landroid/support/v7/widget/y0;->b(II)I
    ...
    :cond_7f
    sget p2, Lb/b/d/a/j;->Toolbar_titleMarginEnd:I
    ...
    :cond_89
    sget p2, Lb/b/d/a/j;->Toolbar_titleMarginTop:I
    ...
    :cond_93
    sget p2, Lb/b/d/a/j;->Toolbar_titleMarginBottom:I
    ...
    :cond_9d
    sget p2, Lb/b/d/a/j;->Toolbar_maxButtonHeight:I

    invoke-virtual {p1, p2, p3}, Landroid/support/v7/widget/y0;->c(II)I

    move-result p2

    iput p2, p0, Landroid/support/v7/widget/Toolbar;->p:I

    sget p2, Lb/b/d/a/j;->Toolbar_contentInsetStart:I

    const/high16 v0, -0x80000000

    invoke-virtual {p1, p2, v0}, Landroid/support/v7/widget/y0;->b(II)I

    move-result p2

    sget v2, Lb/b/d/a/j;->Toolbar_contentInsetEnd:I

    invoke-virtual {p1, v2, v0}, Landroid/support/v7/widget/y0;->b(II)I

    move-result v2

    sget v3, Lb/b/d/a/j;->Toolbar_contentInsetLeft:I

    invoke-virtual {p1, v3, v1}, Landroid/support/v7/widget/y0;->c(II)I

    move-result v3

    sget v4, Lb/b/d/a/j;->Toolbar_contentInsetRight:I

    invoke-virtual {p1, v4, v1}, Landroid/support/v7/widget/y0;->c(II)I

    move-result v4

    invoke-direct {p0}, Landroid/support/v7/widget/Toolbar;->l()V

    iget-object v5, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/q0;

    invoke-virtual {v5, v3, v4}, Landroid/support/v7/widget/q0;->a(II)V
    ...
    :cond_cb
    iget-object v3, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/q0;

    invoke-virtual {v3, p2, v2}, Landroid/support/v7/widget/q0;->b(II)V

    :cond_d0
    sget p2, Lb/b/d/a/j;->Toolbar_contentInsetStartWithNavigation:I
    ...
    sget p2, Lb/b/d/a/j;->Toolbar_contentInsetEndWithActions:I
    ...
    sget p2, Lb/b/d/a/j;->Toolbar_collapseIcon:I
    ...
    sget p2, Lb/b/d/a/j;->Toolbar_collapseContentDescription:I
    ...
    sget p2, Lb/b/d/a/j;->Toolbar_title:I
    ...
    :cond_ff
    sget p2, Lb/b/d/a/j;->Toolbar_subtitle:I
    ...
    iput-object p2, p0, Landroid/support/v7/widget/Toolbar;->k:Landroid/content/Context;

    sget p2, Lb/b/d/a/j;->Toolbar_popupTheme:I
    ...
    sget p2, Lb/b/d/a/j;->Toolbar_navigationIcon:I
    ...
    :cond_128
    sget p2, Lb/b/d/a/j;->Toolbar_navigationContentDescription:I
    ...
    :cond_137
    sget p2, Lb/b/d/a/j;->Toolbar_logo:I
    ...
    :cond_142
    sget p2, Lb/b/d/a/j;->Toolbar_logoDescription:I
    ...
    :cond_151
    sget p2, Lb/b/d/a/j;->Toolbar_titleTextColor:I
    ...
    invoke-virtual {p1, p2, p3}, Landroid/support/v7/widget/y0;->a(II)I
    ...
    :cond_162
    sget p2, Lb/b/d/a/j;->Toolbar_subtitleTextColor:I
...
.method private a(Landroid/view/View;Z)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/Toolbar;->generateDefaultLayoutParams()Landroid/support/v7/widget/Toolbar$e;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/Toolbar;->generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/Toolbar$e;
...
.method private a(Ljava/util/List;I)V
    ...
    invoke-static {p2, v4}, La/a/g;->a(II)I
...
.method private l()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/q0;

    if-nez v0, :cond_b

    new-instance v0, Landroid/support/v7/widget/q0;

    invoke-direct {v0}, Landroid/support/v7/widget/q0;-><init>()V

    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/q0;
...
.method private n()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ActionMenuView;->m()Landroid/support/v7/view/menu/h;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->L:Landroid/support/v7/widget/Toolbar$d;
    ...
    iput-object v1, p0, Landroid/support/v7/widget/Toolbar;->L:Landroid/support/v7/widget/Toolbar$d;
...
.method private o()V
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/ActionMenuView;->a(Landroid/support/v7/view/menu/p$a;Landroid/support/v7/view/menu/h$a;)V
...
.method private p()V
    ...
    sget v3, Lb/b/d/a/a;->toolbarNavigationButtonStyle:I
...
.method public a(II)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/q0;->b(II)V
...
.method public a(Landroid/support/v7/view/menu/h;Landroid/support/v7/widget/ActionMenuPresenter;)V
    ...
    :cond_1f
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->L:Landroid/support/v7/widget/Toolbar$d;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->L:Landroid/support/v7/widget/Toolbar$d;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->k:Landroid/content/Context;
    ...
    :cond_3d
    iget-object p1, p0, Landroid/support/v7/widget/Toolbar;->k:Landroid/content/Context;
    ...
    iget-object p1, p0, Landroid/support/v7/widget/Toolbar;->L:Landroid/support/v7/widget/Toolbar$d;

    iget-object v2, p0, Landroid/support/v7/widget/Toolbar;->k:Landroid/content/Context;

    invoke-virtual {p1, v2, v1}, Landroid/support/v7/widget/Toolbar$d;->a(Landroid/content/Context;Landroid/support/v7/view/menu/h;)V

    invoke-virtual {p2, v0}, Landroid/support/v7/widget/ActionMenuPresenter;->a(Z)V

    iget-object p1, p0, Landroid/support/v7/widget/Toolbar;->L:Landroid/support/v7/widget/Toolbar$d;

    invoke-virtual {p1, v0}, Landroid/support/v7/widget/Toolbar$d;->a(Z)V
...
.method public b()Z
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ActionMenuView;->l()Z
...
.method public c()V
    ...
    :cond_6
    iget-object v0, v0, Landroid/support/v7/widget/Toolbar$d;->c:Landroid/support/v7/view/menu/k;
...
.method protected generateDefaultLayoutParams()Landroid/support/v7/widget/Toolbar$e;
    .registers 3
...
.method public generateLayoutParams(Landroid/util/AttributeSet;)Landroid/support/v7/widget/Toolbar$e;
    .registers 4
...
.method protected generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/Toolbar$e;
    .registers 3
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/Toolbar;->generateLayoutParams(Landroid/util/AttributeSet;)Landroid/support/v7/widget/Toolbar$e;
...
.method protected bridge synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/Toolbar;->generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/Toolbar$e;
...
.method public getContentInsetEnd()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/q0;->a()I
...
.method public getContentInsetLeft()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/q0;->b()I
...
.method public getContentInsetRight()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/q0;->c()I
...
.method public getContentInsetStart()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/q0;->d()I
...
.method public getWrapper()Landroid/support/v7/widget/d0;
    .registers 3

    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->J:Landroid/support/v7/widget/a1;

    if-nez v0, :cond_c

    new-instance v0, Landroid/support/v7/widget/a1;

    const/4 v1, 0x1

    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/a1;-><init>(Landroid/support/v7/widget/Toolbar;Z)V

    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->J:Landroid/support/v7/widget/a1;
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v4/view/n;->e(Landroid/view/View;)I
    ...
    if-eq v6, v12, :cond_1a7

    const/16 v12, 0x50

    if-eq v6, v12, :cond_199
    ...
    check-cast v9, Landroid/support/v7/widget/Toolbar$e;
...
.method protected onMeasure(II)V
    ...
    invoke-direct {v7, v6}, Landroid/support/v7/widget/Toolbar;->d(Landroid/view/View;)Z
    ...
    iget-boolean v2, v7, Landroid/support/v7/widget/Toolbar;->O:Z
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    :goto_1b
    iget v1, p1, Landroid/support/v7/widget/Toolbar$SavedState;->d:I

    if-eqz v1, :cond_2e

    iget-object v2, p0, Landroid/support/v7/widget/Toolbar;->L:Landroid/support/v7/widget/Toolbar$d;
    ...
    :cond_2e
    iget-boolean p1, p1, Landroid/support/v7/widget/Toolbar$SavedState;->e:Z

    if-eqz p1, :cond_3c

    iget-object p1, p0, Landroid/support/v7/widget/Toolbar;->P:Ljava/lang/Runnable;
...
.method public onRtlPropertiesChanged(I)V
    ...
    :goto_13
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/q0;->a(Z)V
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget-object v1, v1, Landroid/support/v7/widget/Toolbar$d;->c:Landroid/support/v7/view/menu/k;
    ...
    iput v1, v0, Landroid/support/v7/widget/Toolbar$SavedState;->d:I
    ...
    iput-boolean v1, v0, Landroid/support/v7/widget/Toolbar$SavedState;->e:Z
