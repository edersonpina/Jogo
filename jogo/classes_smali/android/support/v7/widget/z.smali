...
# instance fields
.field private j:Landroid/support/v7/widget/w0;

.field private k:Landroid/support/v7/widget/w0;
...
.method a()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/z;->j:Landroid/support/v7/widget/w0;

    if-nez v0, :cond_b

    iget-object v0, p0, Landroid/support/v7/widget/z;->k:Landroid/support/v7/widget/w0;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/z;->j:Landroid/support/v7/widget/w0;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/z;->k:Landroid/support/v7/widget/w0;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    sget p2, Lb/b/d/a/j;->AppCompatTextHelper_android_drawableStart:I
    ...
    invoke-static {v0, v1, p2}, Landroid/support/v7/widget/y;->a(Landroid/content/Context;Landroid/support/v7/widget/j;I)Landroid/support/v7/widget/w0;

    move-result-object p2

    iput-object p2, p0, Landroid/support/v7/widget/z;->j:Landroid/support/v7/widget/w0;

    :cond_28
    sget p2, Lb/b/d/a/j;->AppCompatTextHelper_android_drawableEnd:I
    ...
    iput-object p2, p0, Landroid/support/v7/widget/z;->k:Landroid/support/v7/widget/w0;
